...
# Exact operation shapes are disclosed with the selected workflow instead of
# living in the two model-tool schemas sent on every API call. The external
# interface stays stable (study_activity + study_coach), while callers only pay
# for the branch they entered.
_PROMPT_OPERATION_GUIDES: dict[str, list[dict[str, Any]]] = {
    "planning": [
        ...
        return _ok(
            {
                ...
                "fragments": fragments,
                "operation_guide": _PROMPT_OPERATION_GUIDES[intent],
