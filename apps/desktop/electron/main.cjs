...
var require_workspace_cwd = __commonJS({
  "electron/workspace-cwd.cjs"(exports2, module2) {
    ...
    function resolveWorkspaceCwd2({
      ...
      const exists = typeof directoryExists2 === "function" ? directoryExists2 : () => false;
      const candidates = [
        explicitCwd,
        defaultProjectDir,
      ...
      for (const candidate of candidates) {
        ...
        const resolved = path2.resolve(String(candidate));
        if (isPackagedInstallPath2(resolved, { installRoots, isPackaged })) {
          continue;
        }
        if (exists(resolved)) {
          return resolved;
    ...
    module2.exports = { isPackagedInstallPath: isPackagedInstallPath2, resolveWorkspaceCwd: resolveWorkspaceCwd2 };
  }
});
...
var {
  isPackagedInstallPath: isPackagedInstallPathUnderRoots,
  resolveWorkspaceCwd
...
function resolveHermesCwd() {
  return resolveWorkspaceCwd({
    explicitCwd: process.env.HERMES_DESKTOP_CWD,
